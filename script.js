...
/*
 * 약관 / 개인정보처리방침 / 아동 안전 페이지 등의
 * 실제 HTML 콘텐츠를 외부 HTML 파일(xxx-ko.html, xxx-en.html)에서 불러옵니다.
 */
async function loadLegalContent(lang, pageName) {
    const normalizedLang = normalizeLanguage(lang);
    ...
    const fileName = legalFiles[pageName]?.[normalizedLang];
...
/*
 * 기존 JSON 기반 activeTranslations.content 대신 
 * pageName별 xxx-ko.html, xxx-en.html 파일만 불러오도록 전면 적용합니다.
 */
async function applyPageContent(
    ...
    const container =
        document.getElementById("dynamic-content-container");

    if (!container) {
        return;
    }

    // content 대신 지정된 pageName에 맞는 xxx-ko.html / xxx-en.html 불러오기
    await loadLegalContent(lang, pageName);
}
...
function renderTranslations(
    ...
    const activeTranslations =
        getActiveTranslations(normalizedLang, pageName);
    ...
    const sectionKo =
        document.getElementById("sectionKo");

    const sectionEn =
        document.getElementById("sectionEn");
    ...
    const homeBtnText =
        document.getElementById("homeBtnText");

    if (homeBtnText) {
        homeBtnText.textContent =
            activeTranslations["ui.homeButton"] ||
            (
                normalizedLang === "ko"
                    ? "홈으로 가기"
                    : "Back to Home"
    ...
    const titleElement =
        document.querySelector("title[data-i18n-key]");
    ...
    if (langButton) {
        langButton.textContent =
            activeTranslations["ui.toggleLabel"] ||
            (
                normalizedLang === "ko"
                    ? "EN"
                    : "KR"
...
async function applyLanguageAsync(
    ...
    /*
     * 언어 변경 시 외부 HTML 콘텐츠(xxx-ko.html / xxx-en.html)로 교체
     */
            ...
            <div class="container footer-inner">
                ...
                <div class="footer-left">
                    ...
                    <p
                        ...
                        data-i18n-key="footer.copyright"
                    >
                        ${
                            activeTranslations["footer.copyright"] ||
                ...
                <div class="footer-right">
                    ...
                    <ul class="footer-links-list">
                        ...
                        <li>
                            <a
                                href="terms.html"
                                data-i18n-key="footer.terms"
                            >
                                ${
                                    activeTranslations["footer.terms"] ||
                                    "Terms of Service"
                                }
                            </a>
                        </li>
                        ...
                        <li>
                            <a
                                href="privacy.html"
                                data-i18n-key="footer.privacy"
                            >
                                ${
                                    activeTranslations["footer.privacy"] ||
                                    "Privacy Policy"
                                }
                            </a>
                        </li>
                        ...
                        <li>
                            <a
                                ...
                                data-i18n-key="footer.childSafety"
                            >
                                ${
                                    activeTranslations["footer.childSafety"] ||
